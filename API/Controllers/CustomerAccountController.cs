...
namespace API.Controllers
{
    ...
    public class CustomerAccountController : ControllerBase
    {
        ...
        [HttpGet("cutomerTransactions/{id:int}", Name = "GetCustomerTransactionsByid")]
        [Authorize]
        public async Task<ActionResult<ApiResponse<IEnumerable<CustomerTransactionHistoryDTO>>>> GetCustomerTransactionsById(int id)
        {
            ...
            try
            {
                ...
                var transactions = await _customerAccountRepo.GetAllTransactionsByCustomerId(currentUserId, id);
